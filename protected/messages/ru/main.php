...
return array(
	...
	'Лучше всего {is_buy} на {service} общая сумма лотов: {summa} за {price}. Курс составит ~ {course}.' => 'Лучше всего {is_buy} на {service} общая сумма лотов: {summa} за {price}. Курс составит ~ {course}.',
